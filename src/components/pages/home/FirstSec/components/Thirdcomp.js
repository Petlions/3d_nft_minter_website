  ...
  return (
    <Box w='100%' position='relative' isolation='isolate' bg='#000'>
      <Flex gap='20' justifyContent='center' w='100%' minH='40vh' h='max-content'>
        <Card>
          <Text fontSize='1.2em' fontWeight='medium' color='#fff'>Pay to earn Games(P2E).</Text>
        </Card>
      ...
      <Box p='5' h='100%' borderRadius='10px' display='flex' alignItems='center' bg='#ffffff40' backdropFilter='blur(10px)' w='70%' zIndex='1'>
                    <Text position='relative' lineHeight='2em' textAlign='center' fontSize={'1.5em'} fontWeight='700' >PLAY DIFFERENT GAMES ON OUR WEBSITE TO EARN DIFFERENT TYPES OF TOKENS.</Text>
                </Box>
      </Box>
      </Flex>
